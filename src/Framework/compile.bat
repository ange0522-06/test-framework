...
javac -d %BUILD_DIR% ^
src\core\annotations\ControllerAnnotation.java ^
src\core\annotations\URLHandler.java ^
src\core\utils\ActionMapping.java ^
src\core\utils\AnnotationScanner.java

if exist %LIB_JAR% (
    javac -cp "%BUILD_DIR%;%LIB_JAR%" -d %BUILD_DIR% src\core\FrontServlet.java
) else (
